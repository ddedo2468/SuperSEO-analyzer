  ...
  useEffect(() => {
    const generateArticleStructure = async () => {
      ...
      try {
        ...
        return html structure as example <h2> main poinr </h2> <ul> <li> one or 2 points about this main point </li> </ul>with only the tags i should put inside the body, don't include body tag or head tag or html tag don't add any * this is not an md`
